<script>
    ...
    const shopList = [
            {
                ...
                desc: "",
                function: "onSelectC",
                img: document.cloud + "inventoryItems/clothes/male/masks/0_0.png",
                price: 2000,
                line: "line2",
                list: [
                    {
    ...
    const sortFunctions = {
        10: (a, b) => a.price - b.price,
        11: (a, b) => b.price - a.price,
        13: (a, b) => a.line.localeCompare(b.line),
        12: (a, b) => b.line.localeCompare(a.line),
    };

    $: sortedShopList = [...shopList].sort(sortFunctions[pagefilter]);
...
{#if selectIndex > -1}
    ...
    <div class="list1">
        {#each sortedShopList as item, index}
