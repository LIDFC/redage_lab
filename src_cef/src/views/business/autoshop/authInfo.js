export default {
    ...
    "cinquemila": {
        img: "cinquemila",
        desc: "Мощный роскошный седан имеет больше крутящих моментов, чем его водители имеют связей с мафией",
        name: "Lampadati",
        model: "Cinquemila",
        seats: 4,
        acceleration: 8,
    ...
    "iwagen": {
        img: "iwagen",
        desc: "Пришло время смотреть в будущее, но не стоит торопиться. Полностью электрический внедорожник.",
        name: "Obey",
        model: "I-Wagen",
        seats: 4,
        acceleration: 1,
    ...
    "Sugoi": {
        img: "sugoi",
        desc: "В Sugoi столько же завершенности и блеска, сколько в тщательно продуманном брачном ритуале райской птицы",
        name: "Dinka",
        model: "Sugoi",
        seats: 4,
        acceleration: 6,
    ...
    "Vstr": {
        img: "vstr",
        desc: "Ищете что-нибудь дикое? Заберитесь внутрь свирепого V-STR и послушайте, как он рычит, обнажая характерный гриль и подстегивая конкурентов. ",
        name: "Albany",
        model: "V-STR",
        seats: 4,
        acceleration: 8,
    ...
    "Penumbra2": {
        img: "penumbra2",
        desc: "Гоночного автомобиль середины нулевых.",
        name: "Maibatsu",
        model: "Penumbra FF",
        seats: 2,
        acceleration: 5,
    ...
    "Landstalker2": {
        img: "landstalker2",
        desc: "Оригинальный Landstalker подразумевал одну из двух вещей. Вы были наркоторговцем или вы были трофейной женой. Теперь массовый Landstalker XL подразумевает, что вы и то, и другое.",
        name: "Dundreary",
    ...
    "Yosemite3": {
        img: "yosemite3",
        desc: "Yosemite взяли классический пикап и опустили его так низко, что люк мог выскочить из бампера, как крышка от бутылки.",
        name: "Declasse",
    ...
    "Seminole2": {
        img: "seminole2",
        desc: "Отправляйтесь на Seminole Frontier. Будьте в безопасности, выглядите безрассудно, получите все.",
        name: "Canis",
    ...
    "Trophytruck": {
        img: "trophytruck",
        desc: "40 дюймов подвески, прочная, но легкая рама и мощность больше, чем у крылатой ракеты.",
        name: "Vapid",
        model: "Trophy Truck",
        seats: 2,
        acceleration: 5,
